    ...
    <div>
      ...
      <div>
        <div className="text-center py-20">
          <h1 className="font-bold text-center text-[42px] md:text-[52px] bg-gradient-to-t from-[#000] via-[#fff] to-[#fff] inline-block text-transparent bg-clip-text">THE NEXT GEM</h1>
        
          <p className="font-bold text-[19px] md:text-[21px]">Whitepaper V2 - March 31, 2024</p>
          <a className="text-[18px] md:text-[20px]">https://thenextgem.ai</a>
        </div>
        {/* <p className="font-bold text-center text-[40px]" >THE NEXT GEM</p> */}
      </div>
        <ParagraphComponent content="Introducing the next generation of AI-powered tools and platforms for venture capitalists and cryptocurrency enthusiasts. Harness the most advanced neural networks to guide your investment journey while maximizing your time efficiency." />
      <div className="text-[#e6e5e6]">
        
        
        <h3 className="font-bold text-[24px] md:text-[26px] pt-5 pb-10">DISCLAIMER:</h3>
        <div className="text-[20px] md:text-[22px]">
          <SpanSpaceBottom content="THIS DOCUMENT PROVIDES AN INITIAL SUMMARY OF THE NEXTGEM PROJECT. AS THE
            PROJECT PROCEEDS, THIS DOCUMENT IS EXPECTED TO EVOLVE." />
          <SpanSpaceBottom content="THE NEXT GEM TEAM MAY POST MODIFICATIONS, REVISIONS, AND UPDATED DRAFTS UNTIL
            THE FINAL DOCUMENT IS PRESENTED BEFORE THE DATE OF THE PUBLIC BETA." />
          <SpanSpaceBottom content="THIS WHITEPAPER SETS FORTH A DESCRIPTION OF THE PLANNED USE OF THE NEXT GEM
            TOKEN. THIS IS PROVIDED FOR INFORMATION PURPOSES ONLY AND NOT A BINDING LEGAL
            AGREEMENT." />
          <SpanSpaceBottom content="THE NEXT GEM BETA WILL BE GOVERNED BY SEPARATE TERMS & CONDITIONS. IN THE
            EVENT OF A CONFLICT BETWEEN THE TERMS & CONDITIONS AND THIS WHITEPAPER, THE
            TERMS & CONDITIONS GOVERN." />
          <SpanSpaceBottom content=" THIS WHITEPAPER IS NOT AN OFFERING DOCUMENT OR PROSPECTUS AND IS NOT
      ...
      <div>
        <MainHeaderText 
          header="INTRODUCTION"
          title="Abstract & goals"
          description="Year after year, the increasing value and strength of the artificial
...
<ParagraphComponent minimal content="It’s not just about automation or computational speed; it’s about fundamentally reimagining the operational paradigms across sectors." />

<ParagraphComponent minimal content="In the realm of blockchain technology, AI has been a game-changer. It has significantly expanded blockchain’s potential across various domains." />

<ParagraphComponent minimal content="The synergy between AI and blockchain has led to groundbreaking advancements in data analysis, consensus mechanisms, and security protocols, among other areas." />

<ParagraphComponent minimal content=" These transformative improvements continue to refine the landscape of blockchain technology, often in subtle ways that may not be immediately apparent yet are fundamentally altering its trajectory and capabilities." />

<ParagraphComponent minimal content=" Next Gem aspires to be at the forefront of this revolution by introducing a new era in crypto data research and analysis: We aim to build a set of software and tools monitored by the best LLM artificial intelligence available to access all Web3project data directly on their creation and providing our community efficient ways to invest in the most promising crypto projects, on any existing blockchains." />
        <p>
        ...
        <ParagraphComponent minimal content="This allows us to create a specialized version of the LLM that is well-informed about the collective knowledge each AI has generated on specific projects. Consequently, users can access detailed insights through this customized LLM, tailored to provide precise and comprehensive project analyses." />
        
        <ParagraphComponent minimal content="All the scores from these previous different models are cross-referenced. Our custom model will assign its scorederived from an overall average score: all this data will enable us to establish a Trustability factor, allowing you to invest in any project with the best data available on the market." />
        
        <ParagraphComponent minimal content="in any project with the best data available on the market. We are making it by breaking down each document into smaller text segments, known as chunks, and then converting these chunks into embeddings. Embeddings are numerical representations of text that capture the essence of theinformation and can be processed by machine learning models." />
        
        <ParagraphComponent minimal content="These embeddings are stored in a vector database to facilitate efficient searching and retrieval of similar embeddings. When a user has a question, the system embeds it to understand its context and content. It then searches the vector database for chunks of text whose embeddings are similar to the question’s embedding." />
        
        <ParagraphComponent minimal content="The relevant chunks contain information that can help answer the user’s question. Finally, the system sends both the original question and the retrieved chunks of text as context to an efficient language model; it then uses this information to generate a coherent and contextually relevant answer to the initial question." />
        
        <ParagraphComponent minimal content="This process allows for a more informed and precise response by providing the language model with a tailored context extracted from our MongoDB database of text embeddings." />
        
        

        <RepeatingText containsParagraph title="“ What is the note of the project, Solana? Reminds me of the GPT analysis. What he said about it?”" />

        <MainHeaderText 
        title="TOKEN ECONOMICS" 
        header="VISION" 
        description="We must establish a flexible economic model to operate our system efficiently and motivate our community’s active participation in our platform and products. This model should cover parsing, analyzing, and any fees associated with the execution costs of our artificial intelligence tools. ." />
        
        <ParagraphComponent minimal content="Simultaneously, we must ensure that our services remain appealing to our community, encouraging use and engagement and enhancing our visibility within the crypto ecosystem." />
        
        <ParagraphComponent minimal content="The optimal approach to balancing execution services with user engagement is introducing our token, $GEMAI, deployed on the Ethereum blockchain. This token will be necessary for acquiring premium access to some of our paid products, including the custom Next Gem LLM. " />
        
        <ParagraphComponent minimal content="Each premium access will be time-bound, and a certain amount of the $GEMAI token must be burned to gain access. Consequently, the token supply is designed to be deflationary, with its value anticipated to increase alongside the growth of the project and the usage of our products." />
        
        <ParagraphComponent minimal content="While token burning through our premium services is an effective strategy, it’s only sustainable for a while; eventually, we will reach a point where there is no supply left to burn. Therefore, we plan to pivot from a burning mechanism to a locking model at a certain stage. In this model, users must lock $GEMAI tokens for a specific period to gain access to premium services." />

        {/* code logic problem  */}

      
      <h2 className="font-medium text-[22px] md:text-[24px] text-[#f1f1f3] py-8">The total supply of the $GEMAI is 850 million tokens:</h2>
      ...
      description="The roadmap described above is what we have already done and the potential of what we’re thinking to do over the periods; we can’t guarantee that it can be done in time or is possible." />
      </div>
      ...
      {/* footer div section */}
      <div className="py-40 text-[#e6e6e6]">
          <p className="tracking-widest text-[26px]">WHITE PAPER</p>
          <h2 className="font-black text-[45px] md:text-[55px]">THANKS FOR READING.</h2>
      </div>
    </div>
